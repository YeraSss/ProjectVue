<template>
    <div class="group__indicators">
      <div v-for="group_indicator in $store.state.documentsGpList"
        ...
        <ul>
          ...
          <li v-for="indicator in getObjectDataById(
              group_indicator.id,
  ...
  export default {
    ...
    methods: {
      ...mapActions({
        fetchIndicators: "fetchDocIndicators",
        fetchReportsOutList: "fetchDocumentsOutList",
      }),
      cancellAll() {
